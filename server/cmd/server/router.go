		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/agents", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Post("/tasks/{taskId}/resume", h.ResumeAgentTask)
					r.Post("/tasks/{taskId}/bind-issue", h.BindAgentTaskIssue)
					r.Get("/external-sessions", h.ListAgentExternalSessions)
					r.Get("/host-codex-elevation", h.GetHostCodexElevation)
					r.Post("/host-codex-elevation/enable", h.EnableHostCodexElevation)
					r.Post("/host-codex-elevation/disable", h.DisableHostCodexElevation)
					r.Post("/resume-session", h.ResumeExternalSession)
